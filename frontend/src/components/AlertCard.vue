    ...
    <div class="accordion-item">
        ...
        <div v-show="expanded" :id="`collapse${uniqueId}`"
            ...
            <div class="p-4 space-y-4">
                <!-- Metadata Section -->
                <div>
                    <h6 class="flex items-center gap-2 text-sm font-semibold text-gray-900 dark:text-white mb-2">
                ...
                <template v-if="alert.jobInfo">
                    ...
                    <div>
                        ...
                        <div class="ml-6 space-y-1 text-sm">
                            ...
                            <div>
                                <strong class="text-gray-700 dark:text-gray-300">ConfigMap:</strong>
