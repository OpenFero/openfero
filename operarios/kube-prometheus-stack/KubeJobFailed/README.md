...
> **Template**: ships with `spec.enabled: false` and no scope restriction. This deletes failed jobs without manual investigation - review, scope `alertSelector.labels` to your environment, then enable - see [the catalog warning](../README.md#%EF%B8%8F-these-are-templates-not-install-and-forget).
